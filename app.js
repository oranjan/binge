...
const Header = () => {
  return (
    <div className="header">
      <div className="logo">
        <img
          src="https://th.bing.com/th/id/OIG.uqrj_KShADUAYupkgviS?pid=ImgGn"
          alt=" logo-img"
        />
      </div>
...
// console.log(resList[0].data);   // static restaurant cards data from swiggy API
  ...
  return (
    <div className="restaurant-card">
      <img
        ...
        alt=""
      />
      <h2>{props.resData.data.name}</h2>
      <h3>{props.resData.data.deliveryTime} minutes</h3>
      <h3>{props.resData.data.avgRating}</h3>
    </div>
  );
};
